...
def main() -> int:
    ...
    md("**EXPLORATORY SCREENING — NO VERDICTS.** Generated by "
       ...
       "2026-09-22. Bounds and arithmetic only; no claim about the market is "
       "tested here, and nothing in this document may be cited as a verdict. "
       "Interpretation follows the generated tables.")
    md()
    payload = {}

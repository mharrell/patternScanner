...
git add data/intraday data/paper data/intraday_movers data/mover_rosters >> "%LOG%" 2>&1
git diff --cached --quiet
if errorlevel 1 (
  git commit -m "Intraday archive + paper log: nightly pull (auto)" -- data/intraday data/paper data/intraday_movers data/mover_rosters >> "%LOG%" 2>&1
)
